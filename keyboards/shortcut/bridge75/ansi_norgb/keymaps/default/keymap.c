...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [PERSONAL_FN] = LAYOUT_ansi(
        ...
        KC_USB,  LT(0, KC_BT1),  LT(0, KC_BT2),  LT(0, KC_BT3),  LT(0, KC_2G4), _______, _______, _______, _______, _______, _______, _______, _______, _______, PDF(PUBLIC_B),
    ...
    [PUBLIC_FN] = LAYOUT_ansi(
        _______, KC_BRID, KC_BRIU, KC_VOLD, KC_VOLU, KC_MUTE, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, _______, KC_PSCR,                             KC_INS,
        KC_USB,  LT(0, KC_BT1),  LT(0, KC_BT2),  LT(0, KC_BT3),  LT(0, KC_2G4), _______, _______, _______, _______, _______, _______, _______, _______, _______, PDF(MAC_B),
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
    ...
    [MAC_FN] = LAYOUT_ansi(
        _______, KC_BRID, KC_BRIU, KC_VOLD, KC_VOLU, KC_MUTE, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, _______, KC_PSCR,                             KC_INS,
        KC_USB,  LT(0, KC_BT1),  LT(0, KC_BT2),  LT(0, KC_BT3),  LT(0, KC_2G4), _______, _______, _______, _______, _______, _______, _______, _______, _______, PDF(PERSONAL_B),
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,          _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                   _______, _______, EE_CLR,
        _______, _______, _______,                   _______,                            _______, _______,          _______, _______, _______
