...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [PERSONAL_FN] = LAYOUT_ansi(
        ...
        BT_USB,  LT(0, BT_HOST1), LT(0, BT_HOST2), LT(0, BT_HOST3), LT(0, BT_2_4G), _______, _______, _______, _______, _______, _______, _______, _______, _______, PDF(PUBLIC_B),
    ...
    [PUBLIC_B] = LAYOUT_ansi(
        ...
        KC_LCTL, KC_LALT, KC_LGUI,                            KC_SPC,                             KC_RGUI, MO(PUBLIC_FN),    KC_LEFT, KC_DOWN, KC_RGHT
    ),

    [PUBLIC_FN] = LAYOUT_ansi(
        _______, KC_BRID, KC_BRIU, KC_VOLD, KC_VOLU, KC_MUTE, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, _______, KC_PSCR,                   KC_INS,
        BT_USB,  LT(0, BT_HOST1), LT(0, BT_HOST2), LT(0, BT_HOST3), LT(0, BT_2_4G), _______, _______, _______, _______, _______, _______, _______, _______, _______, PDF(PERSONAL_B),
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
